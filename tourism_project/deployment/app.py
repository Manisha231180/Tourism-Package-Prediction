...
# Download the trained model from the Hugging Face Model Hu
model_path = hf_hub_download(repo_id="Manisha231180/tourism-package-model", filename="best_tourism_package_model_v1.joblib")
